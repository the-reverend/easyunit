...
namespace easyunit
{
	...
	public:
		...
		/**
		 * Get the total number of tests that did not run due to an error.
		 *
		 * @return The total number of tests that did not run due to an error.
		 */
		 ...
		 *
		 * @return The total number of tests failed
		 */
		int getTotalFailureCount() const;

		/**
		 * Get the total number of tests successful.
		 *
		 * @return The total number of tests successful
		 */
